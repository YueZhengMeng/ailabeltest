    ...
    eventMaps () {
      ...
      gMap.events.on('drawDone', (type, data) => {
        ...
        let {
          width,
          height
        } = this.gFirstImageLayer.imageInfo;
...
.drawerAl .el-drawer__header, .drawerAl .el-drawer__body, .drawerAl .el-form-item, .drawerAl .el-form-item__label {
  color: #e6e6e6;
}
