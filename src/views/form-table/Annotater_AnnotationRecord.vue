    ...
    <el-card shadow="always">
      ...
      >
        <el-form-item label="状态">
          <el-input v-model="listQuery.checkResult" placeholder="状态" />
        </el-form-item>
        <el-form-item>
      ...
      >
        ...
        <!-- <el-table-column prop="checkResult" label="状态" align="center" /> -->
...
<script>
import { getAnnotationByAnnotaterID } from "@/api/annotater";
...
export default {
  ...
  data() {
    return {
      ...
      // 查询列表参数对象
      listQuery: {
        annotaterID: parseInt(localStorage.getItem("_userID")),
        path: "",
  ...
  methods: {
    ...
    fetchData() {
      ...
      // 获取数据列表接口
      getAnnotationByAnnotaterID(this.listQuery)
        .then((res) => {
          const data = res.data;
