  ...
  <div class="AILabel">
    <ul class="toolbar">
      <li @click="setMode('PAN')">
        <el-tooltip content="平移" effect="customized" placement="center">
          <svg
            class="icon"
            height="50"
            p-id="2275"
    ...
    <!-- 抽屉  -->
    <div class="btnlist">
      <el-button type="success" @click="closewindows">返回</el-button>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      listQuery: {
        ...
        annotationResult: this.$route.query.annotationResult,
        // pageSize: 10
      },
      ...
      imgList: [
        {
          ...
          // src: "http://localhost:9000" + this.$route.query.path,
  ...
  // mounted: function() {
  //   getImageByImageID(this.listQuery.imageID).then(res => {
  //       console.log("getImageByImageID",res)
  //       const data = res.data
  //       this.listQuery.path = data.path
  //       console.log("this.listQuery.path",this.listQuery.path)
  //     })
  // },
  methods: {
    toggleDrawer() {
